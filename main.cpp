...
int main()
{
    ...
    try
    {
        ...
        arr.remove(3);
        arr.print();
        std::cout << "Поиск элемента массива со значением 20 (в случае успеха выводит индекс найденного элемента):" << std::endl;
        arr.searchByVal(20);
        std::cout << "Поиск элемента массива со значением 50 (в случае успеха выводит индекс найденного элемента):" << std::endl;
        arr.searchByVal(50);
        // ПРОВЕРКА: поиск элемента с индексом вне длины массива
        //std::cout << "Поиск элемента с заданным индексом 15:" << std::endl;
        //std::cout << arr.searchByIndex(15) << std::endl;
        std::cout << "Поиск элемента с заданным индексом 9:" << std::endl;
        std::cout << arr.searchByIndex(9) << std::endl;
        // ПРОВЕРКА: изменение размера массива на нулевой
